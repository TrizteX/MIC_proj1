...
Original file is located at
    https://colab.research.google.com/drive/1pdMc0NRyEPShLWj4riKt_0e1a0tn2cMS
"""

#cd drive/'My Drive'/WGAN
...
from wgan import WGAN, Generator, Discriminator
import torch
import os
...
model = CIFAR(train_params, ckpt_params, gan_params)
data_loader = wgan.load_dataset()

torch.manual_seed(100)
model.train(50, data_loader)
